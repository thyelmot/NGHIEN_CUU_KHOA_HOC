...
from Model import Model, GaussianDiffusion, GaussianDiffusionFastSample, Denoise
...
class Coach:
	...
	def prepareModel(self):
		...
		self.diffusion_model = GaussianDiffusionFastSample(args.noise_scale, args.noise_min, args.noise_max, args.steps, num_sample_steps=args.num_sample_steps).cuda()  # [Phuong an 4] rut gon D4 (khong doi D1/D2)
