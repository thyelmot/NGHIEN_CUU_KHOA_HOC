...
from Model import Model, GaussianDiffusion, GaussianDiffusionOT, Denoise
...
class Coach:
	...
	def prepareModel(self):
		...
		self.diffusion_model = GaussianDiffusionOT(args.sigma_min, args.steps).cuda()  # [Phuong an 1] OT-linear path
