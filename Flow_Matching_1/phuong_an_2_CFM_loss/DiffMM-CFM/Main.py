...
from Model import Model, GaussianDiffusion, GaussianDiffusionCFM, Denoise
...
class Coach:
	...
	def prepareModel(self):
		...
		self.diffusion_model = GaussianDiffusionCFM(args.noise_scale, args.noise_min, args.noise_max, args.steps, w_clip=args.w_clip).cuda()  # [Phuong an 2] CFM loss weighting
