...
def ParseArgs():
	...
	parser.add_argument('--sigma_min', type=float, default=1e-3, help='[Phuong an 3] sigma_min cho duong di OT-linear (Flow Matching, eq 20)')
	parser.add_argument('--w_clip', type=float, default=50.0, help='[Phuong an 3] clip cho trong so CFM loss (Min-SNR style)')
	parser.add_argument('--num_sample_steps', type=int, default=0, help='[Phuong an 3] so buoc suy luan rut gon D4 (0 = tu dong = round(0.6*steps))')
