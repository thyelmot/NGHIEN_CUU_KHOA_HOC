...
from Model import Model, GaussianDiffusion, GaussianDiffusionOTCFM, Denoise
...
class Coach:
	...
	def prepareModel(self):
		...
		self.diffusion_model = GaussianDiffusionOTCFM(args.sigma_min, args.steps, w_clip=args.w_clip, num_sample_steps=args.num_sample_steps).cuda()  # [Phuong an 3] OT path + CFM loss + rut gon D4
