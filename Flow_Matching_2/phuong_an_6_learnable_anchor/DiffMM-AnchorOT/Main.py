...
from Model import Model, GaussianDiffusionAnchorOT, Denoise
...
class Coach:
	...
	def prepareModel(self):
		...
		self.diffusion_model = GaussianDiffusionAnchorOT(args.sigma_min, args.steps, w_clip=args.w_clip, num_sample_steps=args.num_sample_steps, anchor_w=args.anchor_w).cuda()  # [Phuong an 6] OT+CFM (Phuong an 3) + diem neo hoc duoc; anchor_w=0 mac dinh => trung khit Phuong an 3
